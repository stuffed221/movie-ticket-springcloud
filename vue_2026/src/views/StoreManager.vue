    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"><el-icon><Grid /></el-icon></i> 商店管理
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                <el-input v-model="query.storename" placeholder="店铺名称" class="handle-input mr10"></el-input>
                <el-input v-model="query.phonenumber" placeholder="店铺电话" class="handle-input mr10"></el-input>
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                ...
                <el-table-column prop="phonenumber" label="店铺电话"></el-table-column>
                <el-table-column prop="createtime" label="创建日期"></el-table-column>
            
                <el-table-column label="操作" width="180" align="center">
                    <template  slot-scope="scope">
                        <el-button type="text" icon="EditPen" @click="showid(scope.row.id)">修改</el-button>
...
//     setup() {
        ...
        const getData = () => {
            ...
            // });
            //从后端拿数据
            var path="http://localhost:8083/shop/page?npage="+query.pageIndex;
